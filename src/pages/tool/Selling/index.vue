<template>
  <div class="user-page">
    <el-form :inline="true" :model="searchForm" ref="searchForm" size="mini">
      ...
      <el-form-item>
        <el-input placeholder="搜索ASIN" style="width:180px;"></el-input>
      </el-form-item>
      <el-form-item>
    ...
    <div class="btn-box">
      <div>
        <el-button size="mini" type="primary">添加ASIN</el-button>
        <el-button size="mini" type="primary">设置监控人</el-button>
        <el-button size="mini" type="primary">批量排除店铺</el-button>
      </div>
          ...
          <template slot-scope="{row, $index}">
            <el-dropdown split-button type="primary" size="mini">
              ...
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item @click="del(row,$index)">设置监控人</el-dropdown-item>
                <el-dropdown-item @click="del(row,$index)">排除店铺</el-dropdown-item>
