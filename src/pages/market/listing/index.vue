<template>
  <div class="user-page">
    <el-form :inline="true" :model="searchForm" ref="searchForm" size="mini">
      ...
      <el-form-item>
        <el-button type="text" @click="search"><i class="el-icon-more"></i></el-button>
        <el-button type="text" @click="search"><i class="el-icon-search"></i></el-button>
      </el-form-item>
    </el-form>
    <div class="btn-box">
      <div>
        <el-button size="mini" type="primary">批量配对</el-button>
        <el-button size="mini" type="primary">导入配对</el-button>
        <el-button size="mini" type="primary">批量分配负责人</el-button>
        <el-button size="mini" type="primary">导入分配负责人</el-button>
      </div>
